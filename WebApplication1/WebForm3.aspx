...
<body>
    ...
    <div>
        ...
        <hr />
        學號:<asp:TextBox ID="txtID" runat="server"></asp:TextBox>
        姓名:<asp:TextBox ID="txtName" runat="server"></asp:TextBox>
        班級:<asp:TextBox ID="txtClass" runat="server"></asp:TextBox>
        <asp:Button ID="btnAdd" runat="server" OnClick="btnAdd_Click" Text="新增" />


        <br />
        學號:<asp:TextBox ID="txtE_ID" runat="server"></asp:TextBox>
        姓名:<asp:TextBox ID="txtE_Name" runat="server"></asp:TextBox>
        班級:<asp:TextBox ID="txtE_Class" runat="server"></asp:TextBox>
        <asp:Button ID="btnEdit" runat="server" OnClick="btnEdit_Click" Text="修改" />


        <br />
        學號:<asp:TextBox ID="txtD_ID" runat="server"></asp:TextBox>
